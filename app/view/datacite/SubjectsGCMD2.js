...
Ext.define('PMDMeta.view.datacite.SubjectsGCMD2', {
	...
	'PMDMeta.model.datacite.Subject',
        'PMDMeta.store.datacite.SubjectGCMD2',
	...
	var me=this;
        ...
        Ext.apply(this, {
            ...
            store: 'DataCiteSubjectGCMD2',
            columns: [	
		{
		cls: 'PMDrequired',			
                header: 'Process/Hazard',
                dataIndex: 'subject',
                flex: 1,
		sortable: false,		
		menuDisabled: true,				
	...
	me.thesaurus.setThesauruses({thesaurus3: 'eposwp16process'});
