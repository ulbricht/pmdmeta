...
Ext.define('PMDMeta.view.datacite.Subjects4DMBDomains', {
	...
	'PMDMeta.model.datacite.Subject',
        'PMDMeta.store.datacite.Subject4DMBDomains',
	'PMDMeta.view.main.ComboBox'
    ],
    xtype: 'DataCite-Subjects4DMBDomains',
    title: '4D Mountain Building Domains',
    frame: true,
    layout: 'fit',
    ...
    initComponent: function() {
        ...
        Ext.apply(this, {
            ...
            store: 'DataCiteSubject4DMBDomains',
            columns: [
		{
		xtype: 'actioncolumn',
		width: 30,
	...
	if (!me.thesaurus){
	    ...
	    me.thesaurus.fireEvent('PMDThesaurusChange',{thesaurus1: '4dmbdisciplines'});
