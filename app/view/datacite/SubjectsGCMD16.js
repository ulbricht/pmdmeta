...
Ext.define('PMDMeta.view.datacite.SubjectsGCMD16', {
	...
	'PMDMeta.model.datacite.Subject',
        'PMDMeta.store.datacite.SubjectGCMD16',
	...
	var me=this;
        ...
        Ext.apply(this, {
            ...
            store: 'DataCiteSubjectGCMD16',
            columns: [	
		{
		cls: 'PMDrequired',			
                header: 'Geologic Class',
                dataIndex: 'subject',
                flex: 1,
		sortable: false,		
		menuDisabled: true,				
	...
	me.thesaurus.setThesauruses({thesaurus3: 'eposwp16palmaggeoclass'});
