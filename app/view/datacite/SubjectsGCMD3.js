...
Ext.define('PMDMeta.view.datacite.SubjectsGCMD3', {
	...
	'PMDMeta.model.datacite.Subject',
        'PMDMeta.store.datacite.SubjectGCMD3',
	...
	var me=this;
        ...
        Ext.apply(this, {
            ...
            store: 'DataCiteSubjectGCMD3',
            columns: [	
		{
		cls: 'PMDrequired',			
                header: 'Geologic structure',
                dataIndex: 'subject',
                flex: 1,
		sortable: false,		
		menuDisabled: true,				
	...
	me.thesaurus.setThesauruses({thesaurus3: 'eposwp16structure'});
