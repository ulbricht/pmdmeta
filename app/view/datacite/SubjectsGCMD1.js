...
Ext.define('PMDMeta.view.datacite.SubjectsGCMD1', {
	...
	'PMDMeta.model.datacite.Subject',
        'PMDMeta.store.datacite.SubjectGCMD1',
	...
	me.thesaurus.setThesauruses({thesaurus3: 'eposwp16setting'});
