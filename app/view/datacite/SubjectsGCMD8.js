...
Ext.define('PMDMeta.view.datacite.SubjectsGCMD8', {
	...
	'PMDMeta.model.datacite.Subject',
        'PMDMeta.store.datacite.SubjectGCMD8',
	...
	me.thesaurus.setThesauruses({thesaurus3: 'eposwp16monitoring'});
