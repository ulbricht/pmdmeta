...
Ext.define('PMDMeta.view.datacite.SubjectsGCMD4', {
	...
	'PMDMeta.model.datacite.Subject',
        'PMDMeta.store.datacite.SubjectGCMD4',
	...
	var me=this;
        ...
        Ext.apply(this, {
            ...
            store: 'DataCiteSubjectGCMD4',
            columns: [	
		{
		cls: 'PMDrequired',			
                header: 'Geomorph. feature',
                dataIndex: 'subject',
                flex: 1,
		sortable: false,		
		menuDisabled: true,				
	...
	me.thesaurus.setThesauruses({thesaurus3: 'eposwp16geologicfeature'});
